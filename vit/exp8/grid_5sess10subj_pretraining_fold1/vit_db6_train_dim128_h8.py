...
def main_1test(chunk_idx):
    ...
    for i, config in enumerate(configs, start=1):
        ...
        losses_accs = train(net=net, net_name=f"{name_prefix}_{chunk_idx}_{i}", ds=ds, k=1, bootstrap='no', training_config=config['training_config'], test_ds=test_ds)
