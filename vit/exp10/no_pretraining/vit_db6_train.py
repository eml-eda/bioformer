...
configs_ = {
    "image_size": (1, 300),
    "patch_size": [(1, 1), (1, 5), (1, 10), (1, 20), (1, 30),
    "channels": 14,
    "num_classes": 8,
    ...
    "training_config": [
        {
         ...
         "lr_scheduler_hparams": {"base_lr": 1e-7, "max_lr": 1e-3, "step_size_up": 100, "step_size_down": None, "mode": 'triangular', "cycle_momentum": False},
        },
    ]
}
