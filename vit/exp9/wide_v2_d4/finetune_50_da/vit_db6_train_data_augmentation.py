...
def main_train_subject(chunk_idx):
    ...
    ds = load(open(f"/home/fbmorghet/vit/exp9/session_augment_v2/train_ds_subject{subject}.pickle", "rb"))
    ...
    "training_config": [
        {
         ...
         "lr_scheduler": "StepLR",
         "lr_scheduler_hparams": {"step_size": 5, "gamma": .1},
        },
        #{
        # "epochs": 25, #25,
        # "batch_size": 64,
