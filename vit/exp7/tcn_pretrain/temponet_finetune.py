...
def main_train_subject(chunk_idx):
    ...
    ds = DB6MultiSession(folder=os.path.expanduser('~/DB6'), subjects=[subject], sessions=train_sessions, steady=steady, n_classes=n_classes, minmax=minmax, image_like_shape=False)
...
configs_ = {
    ...
    "pretrained": "vit_dim64_h2_0_1_fold2_epoch20.pth",
    ...
    "training_config": [
        ...
        #},
        {
         ...
         "batch_size": 64,
         "optim": "SGD",
         "optim_hparams": {"lr": 1e-4, "momentum": 0.9, "dampening": 0, "weight_decay": 0},
         "lr_scheduler": "MultiStepLR", #"StepLR",
         "lr_scheduler_hparams": {"milestones": [10, 20], "gamma": .1}  #{"step_size": 10, "gamma": .1}
        }
    ]
}
