...
def main_1test(chunk_idx):
    ...
    if ds_cache['ds_config'] != ds_config:
        ...
        ds = load(open("/home/fbmorghet/vit/exp8/session_augment_fix/train_ds.pickle", "rb"))
...
def main_train_subject(chunk_idx):
    ...
    ds = load(open(f"/home/fbmorghet/vit/exp8/session_augment_fix/train_ds_subject{subject}_minmax10subjects.pickle", "rb"))
