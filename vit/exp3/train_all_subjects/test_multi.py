...
def train(net, ds, k, n_classes, bootstrap):
    ...
    for epoch in range(epochs):
        ...
        if 'each-epoch' in bootstrap or train_loader is None:
            ...
            train_loader = DataLoader(train_ds, batch_size=64, shuffle=True, pin_memory=True, drop_last=True, num_workers=1)
            train_loader_ = DataLoader(train_ds, batch_size=1024, shuffle=False, pin_memory=True, drop_last=False, num_workers=1)
...
def train_subject(subject, train_sessions=(0,), test_sessions=(1,2,3,4,5,6,7,8,9), steady=True, n_classes='7+1', bootstrap='no', folder='~/DB6'):
    ...
    ds = DB6MultiSession(folder=os.path.expanduser(folder), subject=subject, sessions=train_sessions, steady=steady, n_classes=n_classes, minmax=True, image_like_shape=True)
