...
Original file is located at
    https://colab.research.google.com/drive/1vneCNBsW0NVzSrr_ypFTYaakQJRN6RDi
"""
...
configs_ = {
    ...
    "training_config": [
        ...
        # "lr_scheduler": "StepLR",
        # "lr_scheduler_hparams": {"step_size": 75, "gamma": .5},
        #},
        {
         "epochs": 150,
         "batch_size": 64,
         ...
         "lr_scheduler_hparams": {"base_lr": 1e-7, "max_lr": 5e-4, "step_size_up": 100, "step_size_down": None, "mode": 'triangular', "cycle_momentum": False},
        },
        #{
        # "epochs": 10,
        # "batch_size": 64,
