# -*- coding: utf-8 -*-
"""finetune_a_oltranza.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/192_VRz3-3gN063Y1YjVgu1rvwKpcw5i7
"""
...
#! mkdir -p ~/DB6
#! cd ~/DB6 && wget -q --show-progress -r --no-parent --no-host-directories --cut-dirs=10 http://admin:nimda@lino1.francesco.pw/db6/
...
# 
#         if total_epochs == float('inf') and ok >= 10: # and abs(losses_accs[epoch]['val_acc'] - losses_accs[epoch - 10]['val_acc']) < (1 / 100):
#             scheduler.step()
#             total_epochs = epoch + 10
# 
#         epoch += 1
# 
...
#          "batch_size": 64,
#          "optim": "Adam",
#          "optim_hparams": {"lr": 5e-4, "betas": (.9, .999), "weight_decay": 0},
#          "lr_scheduler": "StepLR",
#          "lr_scheduler_hparams": {"gamma": .1, "step_size": 1},
#         },
#     ]
# }
# 
