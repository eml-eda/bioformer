...
Original file is located at
    https://colab.research.google.com/drive/1S4IjC-dIeZZDh5C8uNVyChqHPezn3cMD
"""
...
! mkdir -p ~/DB6
! cd ~/DB6 && wget -q --show-progress -r --no-parent --no-host-directories --cut-dirs=10 --accept 'S2_*' http://admin:nimda@lino1.francesco.pw/db6/
    ...
    "training_config": [
        {
         ...
         "lr_scheduler": "StepLR",
         "lr_scheduler_hparams": {"gamma": .1, "step_size": 25},
        },
        {
         "epochs": 100,
         "batch_size": 64,
         ...
         "optim_hparams": {"lr": 1e-4, "betas": (.9, .999), "weight_decay": 0},
         "lr_scheduler": "StepLR",
         "lr_scheduler_hparams": {"gamma": .1, "step_size": 50},
        },
        {
         "epochs": 30,
         "batch_size": 64,
