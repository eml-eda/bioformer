...
def main_1test(chunk_idx):
    ...
    if ds_cache['ds_config'] != ds_config:
        ...
        ds_add_sub = DB6MultiSession(folder=os.path.expanduser('~/DB6'), subjects=add_sub, sessions=list(range(n_sessions)), minmax=(ds.X_min, ds.X_max), n_classes='7+1', steady=True, image_like_shape=True).to('cuda')
