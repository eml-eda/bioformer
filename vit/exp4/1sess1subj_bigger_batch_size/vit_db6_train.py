...
configs_ = {
    ...
    "training_config": [
        ...
        #},
        {
         ...
         "optim_hparams": {"lr": 0, "betas": (.9, .999), "weight_decay": 0},
         "lr_scheduler": "CyclicLR",
         "lr_scheduler_hparams": {"base_lr": 1e-7, "max_lr": 1e-4, "step_size_up": 150, "step_size_down": None, "mode": 'triangular', "cycle_momentum": False},
        },
        {
         "epochs": 600,
         "batch_size": 256,
         ...
         "optim_hparams": {"lr": 0, "betas": (.9, .999), "weight_decay": 0},
         "lr_scheduler": "CyclicLR",
         "lr_scheduler_hparams": {"base_lr": 1e-7, "max_lr": 1e-4, "step_size_up": 300, "step_size_down": None, "mode": 'triangular', "cycle_momentum": False},
        },
        {
         "epochs": 1200,
         "batch_size": 256,
         ...
         "optim_hparams": {"lr": 0, "betas": (.9, .999), "weight_decay": 0},
         "lr_scheduler": "CyclicLR",
         "lr_scheduler_hparams": {"base_lr": 1e-7, "max_lr": 1e-4, "step_size_up": 600, "step_size_down": None, "mode": 'triangular', "cycle_momentum": False},
        },
        {
         "epochs": 300,
         "batch_size": 1024,
