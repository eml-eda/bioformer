...
def main_train_subject(chunk_idx):
    ...
    ds = load(open(f"/home/fbmorghet/vit/exp8/session_augment_fix2/train_ds_subject{subject}_minmax10subj5sess.pickle", "rb"))
    ...
    "training_config": [
        {
         ...
         "lr_scheduler": "StepLR",
         "lr_scheduler_hparams": {"step_size": 3, "gamma": .1},
        },
        #{
        # "epochs": 25, #25,
        # "batch_size": 64,
