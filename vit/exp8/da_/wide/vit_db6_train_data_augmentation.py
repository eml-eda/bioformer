# -*- coding: utf-8 -*-
"""vit_db6_train_data_augmentation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kk7AsKg1H-Bx_Y379u2jx6kMjYxxk4xK
"""
...
class DB6SessionAugmented(Dataset):
    ...
    def split(self, total_folds, val_fold=0):
        ...
        self.data_augment_indices = indices[train_mask]
    ...
    for epoch in range(epochs):
        ...
        if 'each-epoch' in bootstrap or train_loader is None:
            ...
            if train_ds[0][0].device.type == 'cpu':
                train_loader = DataLoader(train_ds, batch_size=batch_size, shuffle=True, pin_memory=True, drop_last=True, num_workers=4)
                train_loader_ = DataLoader(train_ds, batch_size=1024, shuffle=False, pin_memory=True, drop_last=False, num_workers=4)
                val_loader = DataLoader(val_ds, batch_size=1024, shuffle=False, pin_memory=True, drop_last=False, num_workers=1)
                if test_ds is not None:
                    test_loader = DataLoader(test_ds, batch_size=1024, shuffle=False, pin_memory=True, drop_last=False, num_workers=1)
            else :
...
def main_1test(chunk_idx):
    ...
    if ds_cache['ds_config'] != ds_config:
        ...
        print("Loading prepreocessed train set")
        ds = load(open("/home/fbmorghet/vit/exp8/session_augment/train_ds.pickle", "rb"))
...
configs_ = {
    ...
    "training_config": [
        ...
        # "lr_scheduler": "StepLR",
        # "lr_scheduler_hparams": {"step_size": 50, "gamma": .5},
        #},
        #{
        # "epochs": 200,
        # "optim": "Adam",
